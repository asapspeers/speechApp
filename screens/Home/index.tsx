...
import SpeechItem, { speeches } from '../../data/speeches'
...
export default function Home({ navigation }: Props) {
  ...
  const renderPopularCard = ({ item }: SpeechItem) => {
    return (
      <Card
        elevation={1}
        style={styles.card}
  ...
  const renderCard = ({ item }: SpeechItem) => {
    return (
      <Card
        style={styles.card}
        onPress={() =>
